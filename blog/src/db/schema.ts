...
import { pgTable, uuid, text, timestamp, boolean, uniqueIndex, pgEnum, ExtraConfigColumn , primaryKey , jsonb,integer } from 'drizzle-orm/pg-core';
...
export const users = pgTable('users', {
  ...
  updatedAt: timestamp('updated_at').defaultNow(),}, (table) => ({
